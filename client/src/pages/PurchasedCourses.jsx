...
const PurchasedCourses = () => {
    ...
    if (courses.length === 0) {
        return (
            <div className="text-center p-10">
                ...
                <Link to="/courses" className="mt-4 inline-block bg-blue-500 text-white px-6 py-2 rounded-lg">Explore Courses</Link>
            </div>
        )
    }
    ...
    return (
        <div className="bg-gray-100 min-h-screen p-8">
            <h1 className="text-4xl font-bold mb-8 text-center">My Purchased Courses</h1>
